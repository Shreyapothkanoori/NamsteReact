...
const RestaurantCard = (props) =>{
    ...
    const {name,area,cloudinaryImageId,costForTwo,avgRating} = props.resData.data;
    ...
    return (
        <div className="body">
            <div className="search">
                <input className="inp" placeholder="search for restaurants or dishes...."/>
                <button className="searchbtn">search</button>
            </div>
            <div className="resto-container">
                {restobj.map((res)=> <RestaurantCard key={res.data.id} resData={res}/>)}
    ...
    return (
        <div className="header">
           <div className="logo-container">
            <img className="logo" src="https://cdn.dribbble.com/users/630677/screenshots/3833541/media/201454f743f48c415a38c49419275692.jpg?resize=400x0" alt="logo"/>
            </div> 
